...
public class TestVWOLogin_04_OptimizedTC_DrMaCoToAll_Log4j extends CommonToAllTest {

    // D - Driver
    // L - Locators
    // V - Validation

    public static final Logger logger = LogManager.getLogger(TestVWOLogin_04_OptimizedTC_DrMaCoToAll_Log4j.class);
