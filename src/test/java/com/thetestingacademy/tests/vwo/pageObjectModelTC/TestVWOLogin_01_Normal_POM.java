...
public class TestVWOLogin_01_Normal_POM {
    ...
    public void test_negative_vwo_login() {
        ...
        String error_message_login = loginPage.loginToVWOInvalidCredentials("adamin@admin.com", "Test@2024");

        //Assertions-3 - V
        assertThat(error_message_login).isNotNull().isNotBlank().isNotEmpty();
        Assert.assertEquals(error_message_login,"Your email, password, IP address or location did not match");
        driver.quit();
